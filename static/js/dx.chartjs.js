...
DevExpress.MOD_VIZ || (function(n) {
    ...
    u.outOfScreen = {
        ...
        getTickInterval: function(n, t, i, r, u) {
            var f = this,
                r = r || f._defaultGridSpacingFactor,
                u = u || f._defaultNumberMultipliers,
                e = i > 0 ? r * t / i : 0;
            switch (n) {
                case "numeric":
        ...
        _areDisplayValuesValid: function(n, t, i) {
            var c = this,
                ...
                r = o.getBBox(),
                f = s.getBBox(),
                h, l = i.translator.businessRange.invertX;
        ...
        _getMaxDisplayValue: function(n, t) {
            var e = this,
                ...
                u, r;
            if (n.length > 0)
                for (i = f(n[0]), r = 1; r < n.length; r++) u = f(n[r]), i.length < u.length && (i = u);
            return i
        },
        ...
        needTickIntervalCalculation: function(n, t, i) {
            ...
            if (r.isDefined(t)) {
                ...
                if (r.isNumber(t))
                    if (t > 0 && n / t > f) i && i("Tick count is too big. So, the tick interval is specified automatically.");
                    else return !1
            }
            return !0
        },
        ...
        getAutoArrangementStep: function(n, t) {
            var e = this,
                i = this._getMaxDisplayValue(n, t),
                r = this._getValueWidth(i, t),
                u, f;
        ...
        getAutoArrangementTicks: function(n, t, i) {
            var e = this,
                u = n,
                i = r.isNumber(i) ? i : e.getAutoArrangementStep(n, t),
                f;
            if (i > 1)
                for (u = [], f = 0; f < n.length; f += i) u.push(n[f]);
        ...
        var f = function(n, t) {
            ...
            e = function() {
                var n = this,
                    i = n.canvas,
                    u = n.businessRange,
                    f = n.businessRange.categoriesX,
                    e = n.businessRange.categoriesY,
                    o, s;
            ...
            n = function(n, t, i) {
                var f = (t + "").match(/canvas_position_(.*)/),
                    r = n.canvas,
                    e, u = n.businessRange;
                if (f) {
    ...
    r.findTheme = function(n) {
        for (var r = u.themes, i, t = 0; t < r.length; t++)
    ...
    r.palettes = {
        ...
        getNextColor: function() {
            var n = this,
                ...
                u = t[n.currentColor],
                r, i;
            if (n.currentColor++, n.currentColor >= t.length && (n.currentColor = 0, n.stepHighlight))
                for (r = n.paletteActions.next(), i = 0; i < t.length; i++) t[i] = new DevExpress.viz.charts.Color(t[i])[r](n.stepHighlight);
            return u
        },
        reset: function() {
    ...
    var r = l.inherit({
        ...
        k = f.inherit({
            ...
            createArcSegments: function(n, t, i, r, u, f) {
                var e = Math.abs(f - u) > Math.PI ? "1" : "0",
                    o = n + r * Math.cos(u),
                    s = t - r * Math.sin(u),
                    h = n + r * Math.cos(f),
                    c = t - r * Math.sin(f),
            ...
            prepareSegments: function(n) {
                ...
                if ("x" in n || "y" in n || "outerRadius" in n || "innerRadius" in n || "startAngle" in n || "endAngle" in n) {
                    var o = i.isNumber(n.x) ? Number(n.x) : 0,
                        s = i.isNumber(n.y) ? Number(n.y) : 0,
                    ...
                    this.segments = [
                        ["M", 0, 0],
                        ["Z"]
                    ], (u || f) && (e = Math.min(u, f), u = Math.max(u, f), f = e, Math.round(t) != Math.round(r) && (Math.abs(r - t) % 360 == 0 && (r -= .0001), t > 360 && (t = t % 360), r > 360 && (r = r % 360), t > r && (t -= 360), t = t * Math.PI / 180, r = r * Math.PI / 180, this.segments = this.createArcSegments(o, s, f, u, t, r))), delete n.x, delete n.y, delete n.outerRadius, delete n.innerRadius, delete n.startAngle, delete n.endAngle, this.combinePathParams(n)
                }
            }
        }),
        d = r.inherit({
        ...
        it = l.inherit({
            ...
            killContainer: function() {
                var t = this,
                    i = t.container && t.getRoot() && t.getRoot().element;
    ...
    var s = t.viz.renderers,
        ...
        l = function(n) {
            ...
            if (e === "div") {
                if (n.childNodes.length > 0)
                    for (t = {}, r = 0; r < n.childNodes.length; r++)(i = l(n.childNodes[r]), i) && (t.left = t.left === undefined || i.left < t.left ? i.left : t.left, t.top = t.top === undefined || i.top < t.top ? i.top : t.top, t.right = t.right === undefined || i.right > t.right ? i.right : t.right, t.bottom = t.bottom === undefined || i.bottom > t.bottom ? i.bottom : t.bottom)
        ...
        r = {
            ...
            _fillAttributesFromCurrentStyle: function(n) {
                var t = this.element,
                    i, r = this.renderer.getRoot(),
                    u = r && r.element.currentStyle.color;
            ...
            _normalizeSettings: function(t) {
                var c, u = {},
                    f = {},
                    e, o, r, i, s, h, v = ["position", "display", "visibility", "filter", "margin", "marginTop", "marginLeft", "marginRight", "marginBottom", "whiteSpace", "clip"];
                for (c in t)
                    if (r = c, i = t[r], r === "x" || r === "translateX") o = t.x || 0, t.translateX && (o += t.translateX), u.left = o + "px";
        ...
        c = i.PathSvgElement.inherit(r).inherit(o).inherit({
            prepareSegments: function(t) {
                ...
                this.callBase(t), v = i.segments, r = h(w, t.x, t.y), r && (a = r.angle, u = r.x, f = r.y, i.segments && (e = a * Math.PI / 180, o = Math.cos(e), s = Math.sin(e), i.segments = n.map(i.segments, function(n) {
                    return n.length === 3 ? (c = n[1], l = n[2], y = (c - u) * o - (l - f) * s + u, p = (c - u) * s + (l - f) * o + f, [
        ...
        v = i.BezierSvgElement.inherit(r).inherit(o),
        nt = v.inherit({
            defaultSettings: function() {
                var n = this.callBase();
                return e({
        ...
        tt = i.ArcSvgElement.inherit(r).inherit(o).inherit({
            createArcSegments: function(n, t, i, r, u, f) {
                var e = n + r * Math.cos(u),
                    ...
                    v = t - i * Math.sin(u);
                return [
                    ["wr", n - i, t - i, n + i, t + i, c, l, a, v],
                    ["at", n - r, t - r, n + r, t + r, e, o, s, h],
                    ["x e"]
                ]
            }
        }),
        ...
        rt = i.BaseSvgElement.inherit(r).inherit({
            ...
            _applyAttributes: function(n) {
                this.callBase(n);
                var n = this.settings,
                    d = this.settings.rotate,
                    t = 0,
                    v, y, i = 1,
                    r = 0,
                    p, w = this.settings.y + (this.settings.translateY || 0),
                    b = this.settings.x + (this.settings.translateX || 0),
                    g = this.settings.align,
                    k = this.getBBox(),
                    c = this._style || {},
                    f = 0,
                    e = 0,
        ...
        var y = function(t) {
            ...
            s = function(r) {
                ...
                if (u.invertY = u.invertY || r.invertY, u.stickY = u.stickY || r.stickY, u.keepValueMarginsY = u.keepValueMarginsY || r.keepValueMarginsY, t(u.minY, r.minY, function(n) {
                    ...
                    for (s = 0; s < f.length; s++) n.inArray(f[s], h) === -1 && h.push(f[s]);
                return this
            },
            h = function(r) {
                var u = this,
            ...
            k = function(n) {
                var t, i, u = r.isDate(n.maxX) || r.isDate(n.minX),
                    f = r.isDate(n.maxY) || r.isDate(n.minY);
            ...
            d = function() {
                var n = this,
                    t, i, u, f, e = r.isDate(n.maxX) || r.isDate(n.minX),
            ...
            g = function() {
                var n = this,
                    t = r.isDate(n.maxX) || r.isDate(n.minX),
                    i = r.isDate(n.maxY) || r.isDate(n.minY);
        ...
        var t = function(t) {
            ...
            u = function() {
                var u = this,
                    ...
                    tt = 0,
                    c = [],
                    e, ot, b, rt, a, ut = n.markerSize,
                    k = n.layout === "horizontal",
                    s, v, t = n.columnCount,
                    i = n.rowCount,
                    h, d = u.legendGroup,
                    f, g, st = n.equalColumnWidth,
                    y = [],
                    ft, p, o, it = !1,
                    w = u.canvas,
                ...
                if (n.visible && r && r.length) {
                    ...
                    if (t && !i ? i = Math.ceil(r.length / t) : !t && i ? t = Math.ceil(r.length / i) : t && i ? k && t < Math.ceil(r.length / i) ? t = Math.ceil(r.length / i) : !k && i < Math.ceil(r.length / t) && (i = Math.ceil(r.length / t)) : (it = !0, k ? (i = 1, t = r.length) : (t = 1, i = r.length)), p = u.getDataRowsColumns(c, t, i), u.moveItems(p, c, f, h, y), it && i === 1)
                        for (o = f.getBBox(); o.width > w.width - w.right - w.left && t > 1;) t = Math.ceil(t / 2), i = Math.ceil(r.length / t), p = u.getDataRowsColumns(c, t, i), u.moveItems(p, c, f, h, y), o = f.getBBox();
                    else if (it && t === 1)
                        for (o = f.getBBox(); o.height > w.height - w.top - w.bottom && i > 1;) i = Math.ceil(i / 2), t = Math.ceil(r.length / i), p = u.getDataRowsColumns(c, t, i), u.moveItems(p, c, f, h, y), o = f.getBBox();
        ...
        e = f.inherit({
            ...
            _getData: function(t, i, r) {
                var y = 4,
                    ...
                    c = [],
                    s = this.options,
                    f = s.arrowLength > 0 ? s.arrowLength : 0,
                    o = r.width + s.paddingLeftRight * 2,
    ...
    f.ChartTitle = e.inherit({
        ...
        render: function() {
            var n = this,
                ...
                f, u, s = n.clipRect ? n.clipRect.id : i,
                h = r.createGroup({
                    "class": "dxChartTitle",
                    clipId: s
                }).append(),
        ...
        var k = function(n, t) {
            ...
            g = function(n) {
                var t, i, f = n.options,
                    ...
                    u;
                if (r && r.getBoundRange && !f.categories)
                    for (i = n.getTickValues(), t = 0; t < i.length - 1; t++) u = Math.abs(i[t] - i[t + 1]), f.isHorizontal ? r.getBoundRange({
                        intervalX: u
                    }) : r.getBoundRange({
                        intervalY: u
                    })
            ...
            ht = function() {
                var i = this,
                    ...
                    e = u.label,
                    s = u.categories,
                    h, f, c = u.isHorizontal ? e.overlappingBehavior : null,
            ...
            lt = function(n, t, i, s) {
                var a = t.isHorizontal ? [e, o] : [u, f],
                    ...
                    y = r.getSignificantDigitPosition(Math.abs(t.max - t.min) / v),
                    c, h = t.min,
                    l = t.max;
            ...
            v = function(n) {
                var t, i = n.options,
                    ...
                    u, r;
                if (!n._tickPositions) {
                    if (t = a(n), i.categories && (i.discreteAxisDivisionMode !== "crossLabels" || !i.discreteAxisDivisionMode))
            ...
            at = function(n, t) {
                var h = n.renderer,
                    ...
                    p, w, r, u;
                if (s.visible)
                    if (u = v(n), n.options.isHorizontal)
            ...
            pt = function(n, t) {
                var u, f = n.options,
                    ...
                    v = h.indentFromAxis,
                    i, e, o, y = [],
                    p = f.isHorizontal ? c.createText : yt,
                    b = f.isHorizontal ? l + v : l - v,
                    s;
                if (h.visible) {
            ...
            kt = function(n, t, r) {
                ...
                if (p.visible)
                    if (y = v(n), n.options.isHorizontal)
                        for (w = l.translateY(u), b = l.translateY(f), k = r.visible && r.left ? l.translateX(e) : i, d = r.visible && r.right ? l.translateX(o) : i, a = 0; a < y.length; a++)(c = y[a], s.abs(c.pos - k) < h || s.abs(c.pos - d) < h) || nt.createLine(c.pos, w, c.pos, b, tt).append(t);
                    else
                        for (w = l.translateX(e), b = l.translateX(o), k = r.visible && r.top ? l.translateY(f) : i, d = r.visible && r.bottom ? l.translateY(u) : i, a = 0; a < y.length; a++)(c = y[a], s.abs(c.pos - k) < h || s.abs(c.pos - d) < h) || nt.createLine(w, c.pos, b, c.pos, tt).append(t)
            },
            dt = function(t, s) {
                var nt = t.renderer,
                    tt = t.options,
                ...
                if (!tt.stubData) {
                    if (g = function(t, i, s, h) {
                            var p = s ? !!(h.minVisibleX || h.maxVisibleX) : !!(h.minVisibleY || h.maxVisibleY),
                                w = (s ? h.categoriesX : h.categoriesY) || [],
                                c = s ? function(n) {
                                    return l.translateX(n)
                                } : function(n) {
                                    return l.translateY(n)
                                },
                                k = s ? !!h.invertX : h.invertY,
                                a = s ? [e, o] : [u, f],
                                d, v = c(t),
                                y = c(i),
                                b = s ? h.minVisibleX : h.maxVisibleY,
                                g = s ? h.maxVisibleX : h.maxVisibleY;
                        ...
                        for (p = l.translateY(u), w = l.translateY(f), a = 0; a < k.length; a++)
                            if (h = k[a], h.startValue !== i && h.endValue !== i && h.color !== i) {
                        ...
                        for (p = l.translateX(e), w = l.translateX(o), a = 0; a < k.length; a++)
                            if (h = k[a], h.startValue !== i && h.endValue !== i && h.color !== i) {
            ...
            ni = function(n, t) {
                var i, r = n.options.label,
                    u, e, o, s, f = !!n.staggered;
                if (t = n.options.inverted ? t.slice(0).reverse() : t, n.options.isHorizontal) {
                    if (r.overlappingBehavior && r.overlappingBehavior.mode === "stagger")
                        for (i = 1; i < t.length; i++) o = t[i - 1], s = t[i], u = o.getBBox(), e = s.getBBox(), e.x < u.x + u.width + r.minSpacing && (n.isStaggerOverlapping = !0, f = !0)
                } else f = !1;
            ...
            ui = function(n) {
                ...
                var n = this.axisElementsGroup.getBBox(),
                    f = this.axisLineGroup.getBBox(),
                    e = this.options.placeholderSize,
                    t, u = this.options.isHorizontal,
                    i = u && "y" || "x",
                    r = u && "height" || "width",
                    o = this.options.position === (u && "bottom" || "right");
    ...
    u.BaseChart = e.inherit({
        ...
        _processAxesOption: function(t) {
            var u = n.isArray(t.argumentAxis) ? t.argumentAxis : [t.argumentAxis],
                f = n.isArray(t.valueAxis) ? t.valueAxis : [t.valueAxis],
                i = function(n) {
        ...
        _processTracker: function() {
            var t = this._element(),
                i = this.option("events"),
                n = this.option("rotated");
        ...
        _processSeriesTemplate: function() {
            var f = this,
                ...
                y = r.isFunction(o.customizeSeries) ? o.customizeSeries : n.noop,
                s = o.nameField || "series",
                c = this._dataSource,
                e, v, u;
            if (c) {
                var h = {},
    ...
    r.Chart = r.BaseChart.inherit({
        ...
        _populateBusinessRange: function(t) {
            var u = this,
                tt = u.panes,
                a = [],
                ft, o, l = u.option("rotated"),
                v, c = l ? u.horizontalAxes : u.verticalAxes,
                p = l ? u.verticalAxes : u.horizontalAxes,
                y = l && "X" || "Y",
                h = l && "Y" || "X",
                w = "getBoundRange" + y,
                b = "getBoundRange" + h,
                et, it = n.map(tt, function(n) {
                    return n.name
                }),
                k = u.series,
                d, g, rt = function(t) {
                    ...
                    if (n.each(c, function(n, r) {
                        ...
                        for (o = 1; o < i.length; o++) r = i[o].options.grid, r && r.visible && (r.visible = !1)
                },
                s = u.paneAxis,
                e = new r.Range,
                ut = function(n, t) {
        ...
        _populateSeries: function() {
            var i = this,
                tt = !!i.option("seriesTemplate"),
                s = tt ? i._templatedSeries : i.option("series"),
                v = n.isArray(s) ? s : s ? [s] : [],
                h = i.option("argumentAxis"),
                f = i.option("valueAxis"),
                y = i.themeManager,
                l, t, p = i.option("commonSeriesSettings"),
                it = i.option("userCommonSeriesSettings"),
                e, w = i.renderer.createGroup({
                ...
                rt = i.option("rotated"),
                nt = i.option("incidentOccured"),
                o, ut = n.map(i.panes, function(n) {
                    return n.name
                }),
                a, c;
        ...
        _createPanesBorderOptions: function() {
            var t = this,
                r = t.option("commonPaneSettings").border,
                i = {};
        ...
        _render: function(t) {
            if (this._seriesInitializing !== !0) {
                var i = this,
                    ...
                    p = i.option("title"),
                    c = 0,
                    l, w = new r.MultiAxesSynchronizer,
                    s = i._createPanesBorderOptions(),
                    a = i.stripsGroup = i.stripsGroup || i.renderer.createGroup({
                        "class": "axis-strips"
                    }),
                    v = function(n, t) {
                        var r, f, i, e;
        ...
        _setPanesClipRectPadding: function(t, i) {
            var r = this,
                u = !0,
                o = t[r.panes[0].name].visible,
                s = t[r.panes[r.panes.length - 1].name].visible,
                f = "",
                e;
        ...
        _drawPanesBorders: function(t) {
            var i = this,
                f = i.option("rotated"),
                u = i.renderer,
                r = i.borderGroup = i.borderGroup || u.createGroup({
                    "class": "dxBorder"
                });
        ...
        _createClipRectsForPanes: function() {
            ...
            t.minClipRectID = [], t.maxClipRectID = [], n.each(t.panes, function(u, f) {
                var c = n.extend({}, r, f.border),
                    e = f.borderCoords,
                    s, h, o = !c.visible && t.paneClipRectPadding || 0;
        ...
        _getElementsClipRectID: function(n) {
            for (var i = this, f = n.pane, u = n.type, r = i.panes, e = r.length, t = 0; t < e; t++)
                if (r[t].name === f) return i._isInBarTypes(u) || u.slice(-4) === "area" ? i.minClipRectID[t] : i.maxClipRectID[t]
        },
        _getMarkersClipRectID: function(n) {
            for (var i = this, u = n.pane, e = n.type, r = i.panes, f = r.length, t = 0; t < f; t++)
                if (r[t].name === u) return i._isInBarTypes(e) ? i.minClipRectID[t] : i.maxClipRectID[t]
        },
        _getTranslator: function(n, t) {
            for (var e = this, r = e.translators, f = r.length, u = null, i = 0; i < f; i++)
        ...
        _processValueAxisFormat: function() {
            var t = this,
                r = t.option("rotated"),
                u = t.series,
                f = r ? t.horizontalAxes : t.verticalAxes,
                i = [];
            n.each(u, function() {
        ...
        _repopulateSeries: function(t) {
            var i = this._dataSource && this._dataSource.items(),
                r = this.option("seriesTemplate");
        ...
        zoomArgument: function(t, i) {
            ...
            r.option("adjustOnZoom") && r._populateBusinessRange({
                ...
                n.each(f, function(n) {
                    var e = r._getTranslator(u, n),
                        o = r._getBusinessRange(u, n);
    ...
    r.PieChart = r.BaseChart.inherit({
        ...
        _populateSeries: function() {
            var t = this,
                d = !!t.option("seriesTemplate"),
                o = d ? t._templatedSeries : t.option("series"),
                l = n.isArray(o) ? o : o ? [o] : [],
                a = t.themeManager,
                h, f, e, s, c, g = t.option("commonSeriesSettings"),
                nt = t.option("userCommonSeriesSettings"),
                v = t.renderer.createGroup({
                    "class": "series"
                }),
        ...
        _processSingleSeries: function(n, t) {
            var u = this,
                o = u.option("commonSeriesSettings"),
                r, i, f, e;
        ...
        _repopulateSeries: function(t) {
            var i = this,
                r = i._dataSource && i._dataSource.items(),
                u = this.option("seriesTemplate");
    ...
    r.ThemeManager = u.BaseThemeManager.inherit(function() {
        var t = function(n, t) {
            ...
            c = function(t, i, u) {
                var c = this,
                    f = n.extend(!0, {}, i || c.theme.commonSeriesSettings),
                    s = n.extend(!0, {}, u || {}),
                    h = (t.type || f.type || "").toLowerCase(),
                    l = ~h.indexOf("area") || ~h.indexOf("bar"),
                    o;
            ...
            l = function(t, i, r) {
                var e = this,
                    u = i || e.theme.commonSeriesSettings || {},
                    f = (t.type || u.type || "").toLowerCase();
                return f && f !== "pie" && (u[f] = n.extend(!0, {}, u[f], u.pie)), t = t || {}, t = n.extend(!0, {}, u, u[f], r, t)
            },
            a = function(t, i) {
                var e = this,
                    o = i || e.theme.commonSeriesSettings || {},
                    u = n.extend(!0, {}, o.pie),
                    s = t.type || u.type || "",
                    f;
        ...
        var v = function(n) {
            ...
            k = function() {
                var o = this,
                    ...
                    c = 10,
                    l = 10,
                    s, h, v = o.chart.chartTitle;
                if (e.visible && u.isNumber(f.width) && u.isNumber(f.height))
            ...
            d = function() {
                var s = this,
                    ...
                    c = s.chart.series,
                    n = c[0] || {},
                    f = i.height - i.top - i.bottom,
                    e = i.width - i.left - i.right,
                    h = e < f ? e : f,
                    o, l = n.outerRadius,
    ...
    var u = t.viz.charts.series,
        ...
        s = o.inherit({
            ...
            storeTrackerR: function() {
                var t = "ontouchstart" in window || window.navigator.msPointerEnabled,
                    n = t ? 20 : 10;
            ...
            drawLabel: function(n, t) {
                if (this.hasValue() && r.isDefined(this.labelFormatObject.value)) {
                    var i = this.options.label,
                        u = this.formatLabel.call(this.labelFormatObject, i);
    ...
    var r = t.viz.charts.series,
        i = r.consts.states,
        f = r.BasePoint,
        u = "canvas_position_default",
        e = f.inherit({
            translate: function(n) {
                if (this.translator = n = n || this.translator, this.translator && this.hasValue())
                    if (this.rotated) {
                        var i = n.translateX(this.minValue),
                            r = n.translateY(this.argument),
                            f = n.translateX(this.value);
                        ...
                        var t = n.translateY(this.minValue),
                            r = n.translateY(this.value),
                            f = n.translateX(this.argument);
            ...
            getTooltipCoords: function() {
                var n = this.translator.getCanvasVisibleArea(),
                    r, u, t, i;
            ...
            drawLabel: function(n, t) {
                if (this.hasValue() && (this.options.label.showForZeroValues || this.labelFormatObject.value)) this.callBase(n, t);
                else return
            },
    ...
    var u = t.viz.charts.series,
        ...
        o = e.inherit({
            ...
            translate: function(n) {
                var i = this.rotated,
                    r = i ? "translateY" : "translateX",
                    t = i ? "translateX" : "translateY";
                if (this.translator = n = n || this.translator, this.translator && this.hasValue()) {
                    var u = n[t](this.openValue),
                        f = n[t](this.highValue),
                        e = n[t](this.lowValue),
                        o = n[t](this.closeValue),
                        s = n[r](this.argument);
            ...
            drawLabel: function(n, t) {
                if (this.hasValue() && f.isDefined(this.labelFormatObject.value)) {
                    var i = this.options.label,
                        r = this.formatLabel.call(this.labelFormatObject, i),
                        u = this.rotated;
        ...
        e = f.inherit({
            ...
            drawLabel: function(n, t) {
                if (this.hasValue() && r.isDefined(this.labelFormatObject.value) && r.isDefined(this.minLabelFormatObject.value)) {
                    var i = this.options.label,
                        f = this.formatLabel.call(this.labelFormatObject, i),
                        e = this.formatLabel.call(this.minLabelFormatObject, i),
                        u = this.translator.getBusinessRange(),
    ...
    var r = t.viz.charts.series,
        ...
        f = u.inherit({
            ...
            drawLabel: function(n, t) {
                if (this.hasValue() || i.isDefined(this.labelFormatObject.value) && i.isDefined(this.minLabelFormatObject.value)) {
                    var r = this.options.label,
                        f = this.formatLabel.call(this.labelFormatObject, r),
                        e = this.formatLabel.call(this.minLabelFormatObject, r),
                        u = this.translator.getBusinessRange(),
                        o = this.series.options.valueAxisType === "discrete",
                        s = o && (!u.invertY && !this.rotated || u.invertX && this.rotated) || !o && this.value > this.minValue && (!u.invertY && !this.rotated || !u.invertX && this.rotated);
            ...
            correctConnectorPosition: function(n, t) {
                if (t) {
                    var i = this.graphic.getBBox(),
                        r, f, u, e, o = this.maxLabelBackground || this.minLabelBackground ? n.y + n.height / 2 : null,
                        s = this.maxLabelBackground || this.minLabelBackground ? n.x + n.width / 2 : null;
    ...
    var e = t.viz.charts.series,
        o = e.consts.events,
        i = e.consts.states,
        r = t.utils,
        v = t.Class,
        y = t.viz.core.ParseUtils,
        s = 20,
        h = 15,
        c = .3,
        f = "allseriespoints",
        ...
        w = v.inherit({
            ...
            _checkValue: function(n) {
                ...
                else if (r.isNumber(n.value)) n.axisType = n.axisType || "continuous", n.type = "numeric";
                else return this._validationResult.error = this._errorMessages.unsupportedFieldMessage(n.field), this.options.incidentOccured.call(null, this._errorMessages.unsupportedFieldMessage(n.field)), !1;
                return !0
            },
            ...
            getRangeData: function(t) {
                ...
                var f = this,
                    e = f.options,
                    p = e.argumentCategories,
                    l = e.argumentAxisType === "discrete",
                    w = e.argumentType,
                    b = e.valueCategories,
                    a = e.valueAxisType === "discrete",
                    k = e.valueType,
                    i = {
            ...
            draw: function(t) {
                var c = {
                    ...
                    }, this.styles.point.states.normal),
                    e = {
                        "class": "labels"
                    },
                    r, o, s, h;
            ...
            drawPoints: function(t, i) {
                var r = this,
                    u = r.styles.point.visible,
                    f = r.areLabelsVisible();
            ...
            _checkArgumentAxisParams: function(n, t) {
                var r = this,
                    i = r.options,
                    o = r._parsedUserOptions,
                    l = o.argumentCategories,
                    u = r._correctAxisType(o.argumentAxisType, o.argumentCategories),
                    e = r._parseUtils.correctValueType(o.argumentType),
                    s, c, h, f = {};
                ...
                for (s = 0; s < n.length; s++)
                    if (h = n[s], r._isTypeSupported(h[t])) {
                        c = h[t];
                        break
                    }
                if (f.value = c, f.field = t, f.axisType = u, f.type = e, r._checkValue(f)) i.argumentAxisType = f.axisType, i.argumentType = f.type;
                else return
            },
            _checkValueAxisParams: function(t, i) {
                var u = this,
                    r = u.options,
                    c = u._parsedUserOptions,
                    y = r.valueField || "val",
                    p = r.rangeValue1Field || "val1",
                    w = r.rangeValue2Field || "val2",
                    b = c.valueCategories,
                    e = u._correctAxisType(c.valueAxisType, c.valueCategories),
                    s = u._parseUtils.correctValueType(c.valueType),
                    f, h, l = {},
                    k, d, a, o = {},
                    g, v;
                ...
                for (f = 0; f < i.length; f++)
                    if (o.value = l[i[f]], o.field = i[f], !u._checkValue(o)) return;
            ...
            _prepareInputData: function(i, u, f) {
                ...
                var o = this,
                    e = o.options,
                    h = e.argumentCategories,
                    l = e.argumentAxisType,
                    y = e.argumentType,
                    c = o._errorMessages,
                    a = o.options.incidentOccured,
                    p = e.valueField || "val",
                    w = e.rangeValue1Field || "val1",
                    b = e.rangeValue2Field || "val2",
                    ot = e.valueCategories,
                    st = e.valueAxisType,
                    k = e.userValueType,
                    d = e.userArgumentType,
                    g = e.userValueAxisType,
                    nt = e.userArgumentAxisType,
                    tt = e.valueType,
                    it = e.tagField || "tag",
                    ht = t.data.query,
                    ct = n.noop,
                ...
                var v = function(t, i, u) {
                        var e = o._parseUtils.getParser(i.toLowerCase(), t + "Axis"),
                            f;
                ...
                return s = n.map(i, function(n) {
                    var o = nt === "discrete" && !d ? n[u] : ft(n[u]),
                        i = {
                            tag: n[it]
                        },
                        e, t;
            ...
            _parseInputData: function(n) {
                var t = this,
                    a = e.pointFactory.createPoint,
                    v = t.options.rotated,
                    y = t.styles.point,
                    u, f = 0,
                    i, r, h, c, l, o = t.options,
                    s = s || o.argumentField || "arg",
                    p = o.tagField || "tag";
                if (n && n.length && (this._canRenderCompleteHandle = !0), t.points = [], t.pointsByArgument = {}, t.segments = [], u = t._checkAndPrepareInputData(n), u && !t._validationResult.error) {
                    if (t.isRangeSeries)
                        for (c = o.rangeValue1Field || "val1", l = o.rangeValue2Field || "val2"; f < u.length; f++) i = u[f], r = a(t.type, {
                            minValue: i[c],
                            value: i[l],
                            argument: i[s],
                            ...
                            tag: i.tag,
                            series: t
                        }), t.pointsByArgument[r.argument] = t.pointsByArgument[r.argument] || r, t.points.push(r);
                    else
                        for (h = o.valueField || "val"; f < u.length; f++) i = u[f], r = a(t.type, {
                            value: i[h],
                            argument: i[s],
            ...
            parseStyleOptions: function(t) {
                var i = n.extend(!0, {}, this.getDefaultStyleOptions(), t),
                    r = {
    ...
    var i = t.viz.charts.series,
        ...
        f = u.inherit({
            ...
            _parseInputData: function(t) {
                var o = this,
                    r, y = i.pointFactory,
                    c = this.options.argumentField || "date",
                    f = this.options.openValueField || "open",
                    s = this.options.highValueField || "high",
                    h = this.options.lowValueField || "low",
                    e = this.options.closeValueField || "close",
                    b = this.options.tagField || "tag",
                    p = this.styles.point,
                    a = this.styles.reduction.color,
                    w = this.styles.reduction.innerColor,
                    v, l, u;
    ...
    var i = t.viz.charts.series,
        ...
        u = r.inherit({
            ...
            prepareBezierAreaPoints: function(t) {
                var r = this.preparedSegments,
                    i = n.map(r[t], function(n) {
                        return n.getCoords()
                    }),
        ...
        e = f.inherit({
            ...
            correctLabelPosition: function() {
                var e = this.label.getBBox(),
                    o = this.options.label,
                    n = t.utils.getCosAndSin(this.middleAngle),
                    u = "center",
                    r = this.radiusOuter + o.radialOffset,
                    f, s;
                switch (o.position) {
                    case "outside":
            ...
            correctConnectorPosition: function() {
                if (this.options.label.position !== "inside" && this.connector) {
                    var r = t.utils.getCosAndSin(i(this.middleAngle)),
                        s = this.series.styles.attributes,
                        c = this.series.userOptions.containerBackgroundColor === s.stroke ? ~~(s.strokeWidth / 2) : ~~(-s.strokeWidth / 2),
                        f = this.radiusOuter,
                        l = i(this.centerX + (f - c) * r.cos),
                        a = i(this.centerY - (f - c) * r.sin),
                        h, u, e, v, n, o = this.options.label,
                        y;
            ...
            rotateLabel: function() {
                var i = this.options.label,
                    f = this.radiusOuter + i.radialOffset,
                    e = t.utils.getCosAndSin(this.middleAngle),
                    r, u, n = this.insideLabelGroup.getBBox();
                switch (i.position) {
                    case "outside":
            ...
            checkEllipsis: function() {
                var r = this,
                    ...
                    v = [],
                    k = [],
                    d, o, y, f, l, e, h = t.utils.getCosAndSin(r.options.label.rotationAngle),
                    u = r.series.canvas,
                ...
                if (r.label.tspans && r.setLabelEllipsis) {
                    if (i = r.label.getBBox(), f = i.x + i.width < r.centerX ? i.x + i.width : i.x, l = i.y + i.height / 2, e = i.x + i.width < r.centerX ? -i.width : i.width, l + e * h.sin > u.height - u.bottom + s || l + e * h.sin < u.top - s || f + e * h.cos < u.left - s || f + e * h.cos > u.width - u.right + s || g.position === "columns" && (p.cos < 0 && w < f || p.cos > 0 && w > f))
                        for (c = 0; c < r.label.tspans.length; c++) b += r.label.tspans[c].element.getNumberOfChars(), (!r.label.tspans[c + 1] || r.label.tspans[c + 1].settings.dy > 0) && (v.push(b), k.push(c), b = 0);
        ...
        e = r.inherit({
            ...
            arrangePoints: function() {
                var i = this,
                    ...
                    h = this.translator,
                    e = 0,
                    o, r, s = i.options.segmentsDirection !== "anticlockwise";
            ...
            s = function(t, i) {
                n.each(t, function(t, r) {
                    ...
                    n.each(u, function(n, t) {
                        var s = t.value,
                            f = r.getStackName ? r.getStackName() : "default",
                            e = s >= 0 ? "positive" : "negative",
                            o;
    ...
    var s = t.viz.charts,
        ...
        r = "allargumentpoints",
        e = "allseriespoints",
        p = window.navigator.msPointerEnabled && window.navigator.msMaxTouchPoints,
        l = 1e3,
        a = 600,
        v = 400,
        o = "none",
        y = c.inherit({
            ...
            _seriesMouseOver: function(t) {
                if (n(t.target).data("series")) {
                    var i = t.data.tracker,
                        u = n(t.target).data("series"),
                        r = n(t.target).data("mode") || u.options.hoverMode,
                        f = function(n, t) {
            ...
            _pointMouseOver: function(t) {
                var i = t.data.tracker,
                    e = i && i.tooltip,
                    u = n(t.target).data("point"),
                    f = u.options.hoverMode,
                    o;
            ...
            _showTooltip: function(n, t) {
                var i = n.data.tracker.tooltip,
                    f = t.getTooltipFormatObject(i),
                    r, u;
    ...
    var p = n.formatHelper,
        c = n.utils.getCosAndSin,
        l = n.utils.normalizeAngle,
        w = n.utils.convertAngleToRendererSpace,
        a = n.utils.isDefined,
        v = n.utils.isString,
        b = n.utils.isFunction,
        e = n.utils.isArray,
        k = window.isNaN,
        r = window.Number,
        d = window.String,
    ...
    n.viz.gauges.__internals.BaseScale = n.Class.inherit({
        ...
        _getCustomValues: function(n, t) {
            var u = this._options.translator,
                i = [];
        ...
        _renderContent: function(n) {
            ...
            if (t._majorTickLength && t._majorTickWidth)
                for (h = v(r.majorTick.color) ? r.majorTick.color : "none", f = t._getTickPoints(t._majorTickLength, t._majorTickWidth), i = 0, u = n.major.length, r.hideFirstTick === !0 && ++i, r.hideLastTick === !0 && --u; i < u; ++i) e = n.major[i], o = t._renderer.createArea(f, {
                    "class": "dx-major-tick",
                    fill: h,
                    stroke: "none",
                    strokeWidth: 0
            ...
            if (t._minorTickLength && t._minorTickWidth)
                for (c = v(r.minorTick.color) ? r.minorTick.color : "none", f = t._getTickPoints(t._minorTickLength, t._minorTickWidth), i = 0, u = n.minor.length; i < u; ++i) e = n.minor[i], o = t._renderer.createArea(f, {
                    "class": "dx-minor-tick",
                    fill: c,
                    stroke: "none",
                    strokeWidth: 0
            ...
            if (t._textIndent)
                for (l = t._getLabelPosition(t._majorTickLength || 0, t._textIndent), i = 0, u = n.major.length, r.hideFirstLabel === !0 && ++i, r.hideLastLabel === !0 && --u; i < u; ++i) e = n.major[i], s = t._formatValue(e.value), f = t._getLabelOptions(s, l, t._textIndent, e), t._renderer.createText(s, f.x, f.y + t._textVerticalOffset, {
        ...
        _formatValue: function(n) {
            var i = this._options.label,
                t = p.format(n, i.format, i.precision);
        ...
        _getCuttingFactor: function(n, t) {
            var i = this,
                w = i._options,
                b = w.translator.getCodomainStart(),
                k = w.translator.getCodomainEnd(),
        ...
        _getCuttingFactor: function(n, t) {
            var i = this._options,
                r = this._vertical ? t.height : t.width,
    ...
    n.viz.gauges.__internals.BaseIndicator = n.viz.gauges.__internals.BaseGaugeItem.inherit({
        ...
        _formatValue: function(n) {
            var t = this._options.text,
                i = r.format(n, t.format, t.precision),
                f = {
                    value: n,
                    valueText: i
                };
        ...
        setCurrentValue: function(n) {
            var t = this,
                i = t._options.translator.adjust(n);
    ...
    var r = n.viz.gauges.__internals.circularNeedles,
    ...
    r.SimpleIndicator = n.viz.gauges.__internals.BaseIndicator.inherit({
        ...
        getTooltipParameters: function() {
            var t = this._options,
                i = n.utils.getCosAndSin(this._getActualPosition()),
        ...
        _create: function() {
            var n = this,
                ...
                r = t.x + t.width / 2 || t.x,
                f = t.y - t.radius,
                o = t.y - t.indentFromCenter || t.y,
                u = f + (o - f) * t.secondFraction || f,
                e = u + t.space || u;
    ...
    var r = n.viz.gauges.__internals.linearNeedles,
        u = t.extend;
    r.SimpleIndicator = n.viz.gauges.__internals.BaseIndicator.inherit({
        _updateActiveElements: function() {
            var n = this,
                t = n._getActualPosition() - n._zeroPosition;
    ...
    var i = n.viz.gauges.__internals.circularMarkers,
        r = n.utils.normalizeAngle,
        e = n.utils.convertAngleToRendererSpace,
        u = n.utils.getCosAndSin,
        f = Math.min;
    i.TriangleMarker = n.viz.gauges.__internals.circularNeedles.SimpleIndicator.inherit({
        ...
        getTooltipParameters: function() {
            var t = this._options,
                r = n.utils.getCosAndSin(this._getActualPosition()),
    ...
    n.viz.gauges.__internals.CircularRangeBar = n.viz.gauges.__internals.BaseRangeBar.inherit({
        ...
        _updateLinePosition: function() {
            var n = this,
                e = r(n._getActualPosition()),
                f = n._getActualPosition(),
                t = n._options.x,
                i, u;
    ...
    n.viz.gauges.__internals.BaseRangeContainer = n.Class.inherit({
        ...
        _getRanges: function() {
            var n = this._options,
                ...
                ot = c(a) / 1e4,
                rt = o(n.palette) ? n.palette : [],
                ut, st = e(n.backgroundColor) ? n.backgroundColor : "none",
                h = n.width || {},
                b = u(h > 0 ? h : h.start),
                nt = u(h > 0 ? h : h.end),
                ft = nt - b;
            return n.ranges ? b >= 0 && nt >= 0 && b + nt > 0 ? (d = l(n.ranges, function(n) {
                n = n || {};
                var i = t.adjust(n.startValue),
                    r = t.adjust(n.endValue);
        ...
        _renderRanges: function(n) {
            var e = this,
                ...
                i = 0,
                u = 0,
                s = t.width > 0 ? t.width : f(t.width.start, t.width.end);
    ...
    var f = n.viz.gauges.__internals,
        r = {
            preset1: {
    ...
    var u = n.viz.gauges.__factory,
        h = n.viz.core.Rectangle,
        o = n.utils.isNumber,
        c = n.utils.isString,
        l = n.utils.isFunction,
        s = window.isFinite,
        v = window.setTimeout,
        f = n.utils.windowResizeCallbacks,
        r = t.extend,
        e = t.each,
        y = 500,
        a = {
    ...
    n.viz.gauges.Gauge = n.ui.Component.inherit({
        ...
        _getIncidentOccured: function() {
            ...
            return l(n) || (n = this._defaultOpts.incidentOccured),
                function() {
        ...
        _getCanvas: function() {
            var i = this,
                ...
                n = i.option("margin") || {},
                f = i._element(),
                e = i._getDefaultContainerSize(),
                r = t.width >= 0 ? Number(t.width) : f.width(),
        ...
        _renderTooltip: function() {
            var n = this,
                t = r({}, n._defaultOpts.tooltip, n.option("tooltip"));
        ...
        _renderIndicator: function(n, t, r, u) {
            var e = this,
                o = e._combineOptions(e._commonOptions, t, r),
                f = n;
    ...
    var u = n.viz.gauges.__factory,
        h = n.utils.isNumber,
        o = window.Number,
        c = n.utils.normalizeAngle,
        l = n.utils.getCosAndSin,
        r = Math.max,
        f = Math.min,
        e = Math.round,
    ...
    n.viz.gauges.CircularGauge = n.viz.gauges.Gauge.inherit({
        ...
        _combineOptions: function() {
            var i = [!0, {}].concat(v.apply(arguments)),
                n = s.apply(t, i);
        ...
        _applyMainLayout: function(n) {
            var s = this,
                ...
                u = f(i.width() / (t.right - t.left), i.height() / (t.down - t.up)),
                h, c;
    ...
    n.viz.gauges.LinearGauge = n.viz.gauges.Gauge.inherit({
        ...
        _combineOptions: function() {
            var i = [!0, {}].concat(h.apply(arguments)),
                n = f.apply(t, i);
    ...
    var s = n.formatHelper,
        f = window.Number,
        h = window.String,
        c = n.utils.isFunction,
        r = Math.round,
        e = t.extend,
        o = 4,
        u = {
    ...
    n.viz.gauges.__internals.Tooltip = n.Class.inherit({
        ...
        _formatValue: function(n, t) {
            var i = this._options,
                u = s.format(n, i.format, i.precision),
                r;
        ...
        _selectMask: function(n, t, i, r, f) {
            var o = this._gauge._rootRect,
                e;
            return e = n + i / 2 > o.right ? u.left : n - i / 2 < o.left ? u.right : t - f - r < o.top ? u.down : u.up
        },
        _getSettings: function(n, t, i, u, e) {
            var w = this._options,
                a = i + 2 * f(w.horizontalPadding),
                v = u + 2 * f(w.verticalPadding),
                l = f(w.arrowLength),
                s = this._selectMask(n, t, a, v, l),
                y, b, p, h, c;
        ...
        show: function(n) {
            n = n || {};
            var t = this,
                f = t._formatValue(n.value, n.context),
                i, u;
        ...
        var v = 5,
            ...
            vt = function(t, u) {
                var f = n.extend(!0, {}, t.option("scale")),
                    h = t.option("incidentOccured"),
                    e = 0,
                    a = new o({
                        incidentOccured: h
                    }),
                    s = a.correctValueType((f.valueType || "").toLowerCase()),
                    l;
            ...
            pt = function(n) {
                var u, r, f, e, i, o, t, s, h, c = n.container,
                    v;
    ...
    r.Scale = r.BaseVisualElement.inherit({
        ...
        _prepareTickIntervalObject: function(n, t) {
            if (u.isObject(n) && u.isString(t))
                for (var i in n) i !== t + "s" && delete n[i]
        },
        ...
        _redraw: function(n) {
            ...
            if (u.showMinorTicks)
                for (i = 0; i < e.length; i++) r._drawTick(e[i], n);
    ...
    r.SlidersContainer = r.BaseVisualElement.inherit(function() {
        return {
            ...
            setSelectedRange: function(n) {
                var t = this,
                    i = t._options.scale,
                    r, e, o = t._options.selectedRange;
    ...
    r.SlidersEventsManager = t.Class.inherit(function() {
        var e = function(n) {
            ...
            c = function(i, o) {
                var p = i._renderer,
                    v, c = i._slidersController,
                    a = i._processSelectionChanged,
                    s = c.getSlider(o),
                    w = s.getAnotherSlider(),
                    y, l, h;
            ...
            l = function(i) {
                var v = i._renderer,
                    c, e = i._slidersController,
                    h = i._processSelectionChanged,
                    y = e.getSelectedAreaTracker(),
                    s = !1,
                    l, a;
    ...
    f.Slider = f.BaseVisualElement.inherit(function() {
        return {
            ...
            _setPositionForBothSliders: function(n, t) {
                var i = this,
                    e, u, f, o, s = i._options.scale.inverted;
            ...
            _correctBusinessValue: function(n, t) {
                var r = this,
                    i = r._correctBusinessValueByAvailableValues(n);
    ...
    r.RangeView = r.BaseVisualElement.inherit(function() {
        ...
        return {
            _draw: function(n) {
                var t = this,
                    o, s, f, u, r, e, i, h = t._options.isEmpty;
                if (e = t._options.seriesDataSource && t._options.seriesDataSource.isShowChart() && !h, i = t._options.canvas, e ? f = t._options.seriesDataSource.getBackgroundColor() : !h && t._options.background.visible && (f = t._options.background.color), t._options.background.visible && f && (o = t._renderer.createRect(i.left, i.top, i.width + 1, i.height, 0, {
                    ...
                    for (u = t._options.seriesDataSource.getSeries(), r = 0; r < u.length; r++) u[r].options.seriesGroup = n, u[r].options.seriesLabelsGroup = n, u[r].options.trackerGroup = n, u[r].draw(t._options.translator), t._options.behavior && t._options.behavior.animationEnabled && u[r].animate()
            }
        }
    }())
}(jQuery, DevExpress), function(n, t, i) {
        ...
        var u = function(n) {
            ...
            o = function(t, o) {
                var w = [],
                    h, b, l, v = u(o.chart),
                    s = o.chart.series,
                    k = o.chart.valueAxis && o.chart.valueAxis.valueType,
                    y, c, a, p;
    ...
    var o = t.viz.rangeSelector,
        ...
        a = function(n) {
            var t, r = 0,
                u = n.getRoot();
            if (u)
                for (t = u.element.parentNode; t && t.offsetLeft !== i; t = t.offsetParent) r += t.offsetLeft;
            return r
        },
        v = function(n) {
            var t = 0;
